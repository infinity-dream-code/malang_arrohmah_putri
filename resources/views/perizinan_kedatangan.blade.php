...
<head>
    ...
    <title>Perizinan Kedatangan/Kepulangan</title>
    @php
        $pageTitle = 'Perizinan Kedatangan/Kepulangan';
    @endphp
...
<body>
            ...
            <div class="card">
                <div class="form-group">
                    <select id="izinType">
                        ...
                        @foreach(session('izin_types_single', []) as $izin)
    ...
    <aside class="drawer" id="drawer">
        ...
        <ul class="drawer-menu">
            <li class="drawer-item">
                <a href="{{ route('perizinan.kedatangan') }}" class="drawer-link active">
    ...
    <script>
        ...
        submitBtn.addEventListener('click', function () {
            ...
            fetch(`{{ route('perizinan.kedatangan.submit') }}`, {
                method: 'POST',
                headers: {
